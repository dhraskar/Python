...
print("calcula o valor do X que voce decidir, de um polinoomio qualquer,")
print("e depois gera seu grafico")
print("------------------------------------------------------------")
...
n_m=(input("Por favor, diga qual o grau do polinomio: "))
n_g=int(n_m)
n=n_g+1
...
plt.title("O grafico da sua funcao e': ")
